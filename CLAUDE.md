...
**YOU ARE IN: `congranulations/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/congranulations/` (rig root) or other directories
...
**Your mail address:** `congranulations/polecats/rust`
**Your rig:** congranulations
**Your Witness:** `congranulations/witness`
...
| Ask Witness for help | `gt mail send congranulations/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`congranulations/witness`) when:
...
```bash
gt mail send congranulations/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
